...
interface PaintDraftRepository {
     ...
     */
    suspend fun getDraft(key: String): PaintSessionDraft?
     ...
     */
    suspend fun saveDraft(key: String, draft: PaintSessionDraft, expectedRevision: Long): Boolean
     ...
     */
    suspend fun removeDraft(key: String, expectedRevision: Long): Boolean
     ...
     */
    suspend fun mergeDrafts(drafts: Map<String, PaintSessionDraft>)
     ...
     */
    suspend fun replaceDrafts(drafts: Map<String, PaintSessionDraft>): Boolean
}
