...
sealed interface SettingsEvent {
    ...
    data class AddImagesToLibrary(val libraryId: String, val uris: List<String>) : SettingsEvent
    data class RemoveImage(val uri: String) : SettingsEvent
    data class RemoveImages(val uris: List<String>) : SettingsEvent
    data class RemoveImagesFromLibrary(val libraryId: String, val uris: List<String>) : SettingsEvent
    data object RemoveAllImages : SettingsEvent
    data class UpdateImageOrder(val uris: List<String>) : SettingsEvent
    data class UpdateLibraryImageOrder(val libraryId: String, val uris: List<String>) : SettingsEvent
    ...
    data class CreateLibrary(val name: String) : SettingsEvent
    data class RenameLibrary(val libraryId: String, val name: String) : SettingsEvent
    data class DeleteLibrary(val libraryId: String) : SettingsEvent
    data class SwitchLibrary(val libraryId: String) : SettingsEvent
